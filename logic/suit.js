...
if (hasilRonde === "Player") {
    skorPlayer++;
    hasil.textContent = 
    `Kamu pilih ${pilihanPemain}, komputer pilih ${pilihanKomputer}. Kamu menang`;
} else if (hasilRonde === "Komputer") {
    skorKomputer++;
    hasil.textContent =
    `Kamu pilih ${pilihanPemain}, komputer pilih ${pilihanKomputer}. Kamu Kalah`;
} else {
    hasil.textContent = 
    `Kamu pilih ${pilihanPemain}, komputer pilih ${pilihanKomputer}. Seri`;
}
